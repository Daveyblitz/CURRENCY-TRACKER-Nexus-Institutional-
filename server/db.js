...
function buildPoolConfig() {
  if (process.env.DATABASE_URL) {
    return {
      ...
      // Neon / Render managed Postgres require SSL. rejectUnauthorized:false
...
// Translate sqlite-style "?" placeholders to Postgres "$1, $2, ..." so the
// existing route handlers keep working unchanged.
